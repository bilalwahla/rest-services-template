[![Build Status](https://travis-ci.org/bilalwahla/rest-services-template.svg?branch=master)](https://travis-ci.org/bilalwahla/rest-services-template) [![codecov](https://codecov.io/gh/bilalwahla/rest-services-template/branch/master/graph/badge.svg)](https://codecov.io/gh/bilalwahla/rest-services-template)
