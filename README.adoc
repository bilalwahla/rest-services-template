...
If you use **Postman** for testing web services, please find Postman collection and environment it depends on under _src/main/test/resources/postman_. All you need to do is to import them in to Postman and that's it, they are ready to test this service.
